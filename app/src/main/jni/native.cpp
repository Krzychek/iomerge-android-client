...
JNIEXPORT void JNICALL Java_org_kbieron_iomerge_android_IOManager_moveMouse(JNIEnv *env, jobject instance, jint x, jint y) {
...
JNIEXPORT void JNICALL Java_org_kbieron_iomerge_android_IOManager_mouseClick(JNIEnv *env, jobject instance, jint x, jint y) {
    struct input_event event;
    event.type = KEY_DOWN;
    // TODO bla bla..
    send_event(event);
