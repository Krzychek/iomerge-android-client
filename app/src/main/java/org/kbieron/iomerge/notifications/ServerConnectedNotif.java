...
/**
 * Helper class for showing and canceling server connected  notifications.
 * <p/>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
@EBean
public class ServerConnectedNotif {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "ServerConnectedNotif";

    @StringRes
    protected static String ticker;
     ...
     * presentation of server connected notif notifications. Make
     * sure to follow the
     ...
     * @see #cancel(Context)
     */
    public void notify(final Context context, final String exampleString, final int number) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_server_connected_notif) //
